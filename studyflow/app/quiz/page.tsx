                ...
                {currentQuestion.options.map((option, optionIdx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex w-full items-center gap-3.5 rounded-lg border p-4 text-left text-sm transition ${
                        isSelected
                          ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-900 shadow-sm"
                          : "border-zinc-200 bg-white text-zinc-800 hover:border-zinc-400 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:border-zinc-700 dark:hover:bg-zinc-850"
                      }`}
                    >
                      <span
